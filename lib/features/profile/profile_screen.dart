...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFF2F2F6), // Light grayish background matching the screenshot
              ...
              children: [
                ...
                Stack(
                  ...
                  children: [
                    ...
                    Container(
                      margin: const EdgeInsets.only(bottom: 60), // Space for the avatar to overlap
                      height: 200,
                      decoration: const BoxDecoration(
                        color: Color(0xFF413F54), // Matches the dark appbar color
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: const BoxDecoration(
                          color: Color(0xFFF2F2F6), // Match scaffold background to act as border
                ...
                // User Info
                Text(
                  userModel.username.isNotEmpty ? userModel.username : 'Unknown',
                  style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: Color(0xFF262532)),
                ),
                const SizedBox(height: 4),
                Text(
                  userModel.matricNo.isNotEmpty ? userModel.matricNo : 'No ID Available',
                  style: const TextStyle(color: Color(0xFF6B6A7C), fontSize: 14, fontWeight: FontWeight.normal),
                ),
                ...
                _buildMenuCard([
                  ...
                  const Divider(height: 1, indent: 70, endIndent: 20, color: Color(0xFFEEEDF2)),
                  _buildMenuItem(
